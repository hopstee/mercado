...
class BanTypeController extends PanelController
{
	public function setup()
	{
		...
		|--------------------------------------------------------------------------
		*/
		$this->xPanel->setModel('App\Models\BanType');
		$this->xPanel->setRoute(admin_uri('ban_types'));
		$this->xPanel->setEntityNameStrings(trans('admin::messages.ban types'), trans('admin::messages.ban types'));
