@if (isset($categoriesOptions) and isset($categoriesOptions['type_of_display']))
	...
	<div class="container" id="categories-home">
		<div class="col-xl-12 content-box layout-section categor">
			<div class="row row-featured row-featured-category">
				<!-- <div class="col-xl-12 box-title no-border">
					<div class="inner">
						<h2>
							<span class="title-3"><span style="font-weight: bold;">{{ t('Category') }}</span></span>
							<a href="{{ \App\Helpers\UrlGen::sitemap() }}" class="sell-your-item" style="padding-right:0px;">
