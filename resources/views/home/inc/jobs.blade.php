...
<div class="container">
    <div class="col-xl-12 content-box layout-section no-paddings d-none d-sm-block">
        <div class="row row-featured row-featured-category">
            <div class="col-xl-12 box-title no-border">
                <div class="inner" style="display: flex;align-items: center;justify-content: space-between;">
                    <h2 style="padding-left:15px;">
                        <span class="title-3">{!! t('Home - Latest Jobs') !!}</span>
                    </h2>
                    <h2 style="padding-right:15px;">
                        <?php $attr = ['countryCode' => config('country.icode')]; ?>
                        <a href="{{ lurl(trans('routes.job-search', $attr), $attr) }}" class="more-arrow-but" >
            ...
            <div id="jobsList" class="adds-wrapper noSideBar category-list make-grid">
                <?php
                        ...
                        <div class="{{ $colDescBox }} add-desc-box">
                            <div class="items-details">
                                ...
                                <h5 id="h5-col" class="add-title ellipsis-text">
                                    <a href="{{ \App\Helpers\UrlGen::post($post) }}">{{ \Illuminate\Support\Str::limit($post->title, 150) }}
                                    </a>
                                </h5>
                                ...
                                <span class="info-row ellipsis-text">
                                    ...
                                    <span class="category">
                                        ...
                                        <a href="{!! qsurl(config('app.locale').'/'.trans('routes.v-search', ['countryCode' => config('country.icode')]), array_merge(request()->except('c'), ['c'=>$liveCatId]), null, false) !!}"
                ...
                @if (isset($latestOptions) and isset($latestOptions['show_view_more_btn']) and
                $latestOptions['show_view_more_btn'] == '1')
                <!-- <div class="mb20 text-center separator">
                    <?php $attr = ['countryCode' => config('country.icode')]; ?>
                    <a href="{{ lurl(trans('routes.job-search', $attr), $attr) }}">
