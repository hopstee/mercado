                                        ...
                                        try { 
                                            if (auth()->check() && auth()->user()->can(\App\Models\Permission::getStaffPermissions())) {
                                                ...
                                                $select = "<select id='ban_type_id' name='ban_type_id' class='btn btn-danger btn-block' onchange='submit();' value=" 
                                                        . trans('admin::messages.ban_the_user') ."><option style='color: #212121;' selected disabled>" .trans('admin::messages.ban_the_user') . $values . "</select>";
